"""
Calculadora segura para que el agente no tenga que hacer cuentas "de memoria".
...
# Formato de function declaration que espera la Gemini API (google-genai).
# Es el mismo concepto que el "input_schema" de Anthropic, pero con los
# tipos en mayúscula (OBJECT, STRING, etc) y la clave "parameters" en vez
# de "input_schema".
