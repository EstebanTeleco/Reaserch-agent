...
def web_search(query: str, max_results: int = 5) -> str:
    ...
    para que el agente lo pueda leer y citar la fuente que corresponda.
    """
    try:
        ...
        # respuesta final, el agente pueda referenciar de dónde sacó cada dato
        formatted = []
...
# Mismo cambio que en calculator.py: formato de function declaration de
# Gemini (tipos en mayúscula, clave "parameters" en vez de "input_schema")
